$(document).ready(function() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                response.forEach(function(docente) {
                    docentesHtml += '<option value="' + docente.duiDocente + '"' + 
                                    (docente.duiDocente === duiDocenteActual ? ' selected' : '') + '>' + 
                                    docente.nombreDocente + ' ' + docente.apellidoDocente + '</option>';
                });
    ...
    function toggleSubmitButton(duiDocenteActual) {
        ...
        if (duiDocenteSeleccionado === "" || duiDocenteActual === duiDocenteSeleccionado) {
    ...
    $('#actualizarMateriaModal').on('show.bs.modal', function(event) {
        ...
        $('#profesor').val(button.data('profesor')).data('current-docente', duiDocenteActual);
    });
